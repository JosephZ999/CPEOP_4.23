...
void AShriekerSummon::AnimUpdate()
{
	switch (GetState())
	{
	case EBaseStates::Stand:	{ SetAnim(FName("Stand"),	false);	break; }
	case EBaseStates::Jumping:	{ SetAnim(FName("Jumping"),	false);	break; }
	}
}
...
void AShriekerSummon::LandAttack()
{
	...
	SpawnHelper("ShriekerSummonSlash", AnimElemTime(4));
}
...
void AShriekerSummon::JumpAttack()
{
	...
	SpawnHelper("ShriekerSummonSlash2", AnimElemTime(3));
}
