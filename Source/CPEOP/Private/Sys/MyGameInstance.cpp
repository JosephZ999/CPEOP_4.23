...
{
	if (FightClasses.Sparks.Num() > index)
	{
		return FightClasses.Sparks[index];
	}
	return nullptr;
}
...
{
	return FightClasses.DamageText;
}
...
TSubclassOf<class ADangerBox> UMyGameInstance::GetDangerBoxClass_Implementation()
{
	return FightClasses.DangerBox;
}
